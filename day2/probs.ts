...
class BackAccount {
    ...
    constructor(total: number, amount: number) {
        this.total = total
        this.amount = amount
    }
...
const newAmount = new BackAccount(500, 250)
...
function filterPrime(numbers: number[]): number[] {
...
const arrayNum: number[] = [2,4,435,46,23,7,52]
const primeNum: number[] = filterPrime(arrayNum)

console.log(primeNum)

//Q3=============================================

//COMMENT: Understood most parts, I had to look up how to use the sort method and also how to accurately get the date, it's syntax, and the function that establishes it as real time, which was the getDate() function.
...
function sortTodo(list: TodoItem[]): TodoItem[] {
    list.sort((a, b) => {
...
const sortedList = sortTodo(items)
console.log(sortedList)

//Q4============================================

//COMMENT: Finding it very hard to remember array helpers. Need to practice those more

function newArr(numbers: number[]): number[] {
    return numbers.filter((num) => {
        if(num % 2 === 0) {
            return true
        }
...
const input: number[] = [2,3,5,43,64,3421,64,52]
const evenNum: number[] = newArr(input)
console.log(evenNum)